...
exports.getNextReviewTime = getNextReviewTime;
...
function getNextReviewTime(reviewCount) {
    ...
    const days = index < REVIEW_INTERVALS_DAYS.length
 ...
 * @returns 留存率 (0~1)
 */
function getRetentionRate(elapsedDays, reviewCount) {
    // 稳定系数：复习次数越多，记忆越稳定
    const stability = 1 + reviewCount * 2; // 1, 3, 5, 7, ...
    return Math.exp(-elapsedDays / stability);
}
//# sourceMappingURL=ebbinghaus.js.map